...
BucketMock.prototype.lenqueMulti = function(side, keys, options, callback) {
    if (!options) {
        options = {};
    }
...
BucketMock.prototype.lenqueueMulti = function(keys, options, callback) {
    return this.lenqueMulti(-1, keys, options, callback);
};

BucketMock.prototype.lremMulti = function(side, keys, options, callback) {
    if (!options) {
        options = {};
    }
...
BucketMock.prototype.lremoveMulti = function(keys, options, callback) {
    return this.lremMulti(-1, keys, options, callback);
};


BucketMock.prototype.sAddMulti = function(side, keys, options, callback) {
    if (!options) {
        options = {};
    }
...
BucketMock.prototype.saddMulti = function(keys, options, callback) {
    return this.sAddMulti(-1, keys, options, callback);
};

BucketMock.prototype.sremMulti = function(side, keys, options, callback) {
    if (!options) {
        options = {};
    }
...
BucketMock.prototype.sremoveMulti = function(keys, options, callback) {
    return this.sremMulti(-1, keys, options, callback);
};
...
BucketMock.prototype.lenqueue = function(key, value, options, callback) {
    if (callback === undefined) {
        callback = options;
        options = {};
    }
    ...
    this.lenqueueMulti([key], options, function(err, results) {
        if (err && err.code === errors.checkResults) {
            return callback(results[key].error);
        } else if (err) {
            return callback(err);
...
BucketMock.prototype.lremove = function(key, value, options, callback) {
    if (callback === undefined) {
        callback = options;
        options = {};
    }
    ...
    this.lremoveMulti([key], options, function(err, results) {
        if (err && err.code === errors.checkResults) {
            return callback(results[key].error);
        } else if (err) {
            return callback(err);
